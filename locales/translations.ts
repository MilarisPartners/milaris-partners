export const translations = {
  FR: {
    navbar: {
      ...
      businessAcquisition: "Acquisition d'entreprise",
    ...
    about: {
      ...
      content: {
        ...
        point2: {
          ...
          text2: "et en",
          country3: "Allemagne",
          text3: ", nous privilégions une approche exclusive avec un nombre limité de mandats. Méthode rigoureuse, réseau international, sens du deal : nous ouvrons le champ des possibles pour maximiser valeur, options et réussite."
        },
        point3: {
          text1: "Pionniers de l'intégration de",
          ai: "l'intelligence artificielle",
          text2: "en M&A, notre technologie propriétaire optimise chaque étape de la transaction pour maximiser vos chances de succès."
        }
      }
    },
    services: {
      ma: {
        title: "Fusions et",
        titleHighlight: "Acquisitions",
        description: "Notre équipe d'experts vous accompagne dans toutes les étapes de votre projet de cession ou d'acquisition. Avec une approche personnalisée et un réseau international, nous maximisons la valeur de votre transaction.",
        steps: {
          analysis: {
            title: "Analyse",
            description: "Évaluation approfondie de votre entreprise"
          },
          valuation: {
            title: "Valorisation",
            description: "Détermination de la juste valeur"
          },
          targeting: {
            title: "Ciblage",
            description: "Identification des acquéreurs potentiels"
          },
          negotiation: {
            title: "Négociation",
        ...
        tagline: "Excellence • Innovation • Résultats"
      },
      fundraising: {
        title: "Levée de",
        titleHighlight: "fonds",
        description: "Accélérez votre croissance avec notre expertise en levée de fonds. Nous vous connectons avec les investisseurs les plus pertinents et vous accompagnons dans la structuration et la négociation de votre financement.",
        steps: {
          businessPlan: {
            title: "Business Plan",
            description: "Structuration de votre projet"
          },
          network: {
            title: "Réseau",
          ...
          presentation: {
            title: "Présentation",
            description: "Préparation des pitchs"
          },
          closing: {
            title: "Closing",
            description: "Finalisation du financement"
          }
        },
        tagline: "Croissance • Financement • Succès"
      }
    },
    expertise: {
    ...
    aiSection: {
      ...
      features: {
        ...
        qualifyTargets: {
          title: "Qualification rapide de cibles pertinentes",
        },
        saveSourcing: {
          title: "Réduction significative du temps de sourcing",
        },
        objectiveValuation: {
          title: "Valorisation objective des cibles",
        },
        marketKnowledge: {
          title: "Market knowledge fort et multi-sectoriel",
        }
      },
      stats: {
        data: {
    ...
    process: {
      title: "Notre processus en",
      titleHighlight: "4 étapes",
      subtitle: "Un accompagnement structuré et transparent pour maximiser vos chances de succès",
      steps: {
        discovery: {
          number: "01",
          title: "Découverte",
          description: "Analyse approfondie de votre entreprise, de vos objectifs et de votre marché pour définir la stratégie optimale."
        },
        preparation: {
          number: "02",
          title: "Préparation",
          description: "Constitution du dossier de présentation, valorisation et identification des contreparties potentielles."
        },
        negotiation: {
          number: "03",
          title: "Négociation",
          description: "Gestion des échanges, négociation des termes et accompagnement jusqu'à la signature de la lettre d'intention."
        },
        closing: {
          number: "04",
          title: "Closing",
          description: "Finalisation de la documentation juridique, coordination des due diligences et accompagnement jusqu'au closing."
        }
      }
    },
    europePresence: {
      ...
      stats: {
        ...
        volume: {
          value: "€2Mds+",
          label: "de volume traité"
        },
        network: {
          value: "5000+",
          label: "investisseurs dans notre réseau"
        }
      }
    },
    contact: {
      modalTitle: "Contactez-",
      modalTitleHighlight: "nous",
      modalSubtitle: "Nous sommes à votre écoute pour discuter de votre projet",
      title: "Planifions un échange",
      subtitle: "Notre équipe est à votre disposition pour discuter de votre projet",
      form: {
        ...
        emailProfessional: "Email professionnel",
        phone: "Téléphone (optionnel)",
        phonePlaceholder: "+33 6 12 34 56 78",
        company: "Société",
        project: "Votre projet",
        projectTypes: {
          sale: "Cession d'entreprise",
        ...
        successMessage: "Merci pour votre message. Notre équipe vous contactera dans les plus brefs délais.",
        errorMessage: "Une erreur s'est produite. Veuillez réessayer."
      },
      directContact: "Ou contactez-nous directement :",
      emailAddress: "contact@milaris.partners"
    },
    footer: {
    ...
    expertisePages: {
      cession: {
        ...
        stats: {
          successRate: {
            value: "98%",
            label: "Taux de succès des opérations"
          },
          duration: {
            value: "6-9",
            label: "Mois en moyenne par cession"
          },
          valuation: {
            value: "+25%",
            label: "Valorisation moyenne obtenue"
          },
          confidentiality: {
            value: "100%",
          ...
          strategic: {
            ...
            benefits: {
              synergies: {
                ...
                subtitle: "Maximisation de la valeur par l'intégration"
              },
              integration: {
                title: "Intégration dans un groupe existant",
                subtitle: "Continuité et développement assuré"
              },
              continuity: {
                title: "Continuité opérationnelle",
                subtitle: "Préservation des équipes et savoir-faire"
              }
            }
          },
          financial: {
            ...
            benefits: {
              growth: {
                ...
                subtitle: "Ressources pour accélérer le développement"
              },
              management: {
                title: "Maintien du management",
                subtitle: "Continuité de la direction opérationnelle"
              },
              exit: {
                title: "Perspective de sortie",
                subtitle: "Horizon d'investissement 3-7 ans"
              }
            }
          }
        },
        faq: {
          ...
          questions: {
            ...
            q3: {
              ...
              answer: "Chaque échange s'effectue sous accord de confidentialité. Nous utilisons des NDAs, codes projets, data rooms sécurisées et une approche progressive des acquéreurs pour maintenir la confidentialité tout au long du processus."
            },
            q4: {
        ...
        faq: {
          ...
          questions: {
            ...
            q3: {
              ...
              answer: "Nous structurons tous types d'opérations : acquisition simple, LBO avec effet de levier, prise de participation minoritaire ou majoritaire, carve-out de divisions, stratégies build-up. Chaque structure est optimisée selon vos contraintes."
            },
            q4: {
      ...
      financement: {
        ...
        timeline: {
          ...
          steps: {
            preparation: {
              ...
              description: "Business plan, modélisation financière, préparation du pitch et des documents clés",
            ...
            pitch: {
              ...
              description: "Présentation aux investisseurs, gestion des Q&A, négociation des term sheets",
              duration: "4–8 semaines"
            },
            closing: {
        ...
        stats: {
          ...
          minimum: {
            value: "2M€+",
            label: "Seuil minimal d'intervention"
          }
        },
        whyMilaris: {
          title: "Pourquoi Milaris Partners ?",
        ...
        types: {
          ...
          equity: {
            ...
            items: {
              ...
              angels: {
                title: "Business Angels et clubs d'investisseurs",
          ...
          debt: {
            ...
            items: {
              bank: {
                ...
                subtitle: "Financements classiques sécurisés"
              },
              private: {
              ...
              bonds: {
                ...
                subtitle: "Pour les besoins importants"
              },
              lease: {
                title: "Crédit-bail et solutions spécialisées",
                subtitle: "Financements d'actifs spécifiques"
              }
            }
          }
        },
        faq: {
          ...
          questions: {
            ...
            q2: {
              question: "Quelle est la différence entre dette et equity ?",
              answer: "L'equity implique une dilution du capital en échange de fonds propres, tandis que la dette est un prêt à rembourser avec intérêts. L'equity offre plus de flexibilité mais dilue, la dette préserve le capital mais impose des remboursements réguliers."
            },
            q3: {
              question: "Comment optimiser ma valorisation ?",
              answer: "Une valorisation optimale résulte d'une préparation rigoureuse : business plan solide, métriques de croissance démontrées, processus concurrentiel bien organisé et timing adapté au marché. Notre expertise maximise chaque levier."
            },
            q4: {
              question: "Quels montants pouvez-vous lever ?",
              answer: "Nous accompagnons des levées de fonds à partir de 2M€ jusqu'à plus de 100M€, en equity comme en dette. Notre réseau couvre tous les types de tickets, des business angels aux grands fonds institutionnels européens."
            }
          }
        },
        cta: {
          title: "Prêt à financer votre croissance ?",
          subtitle: "Discutons de vos besoins de financement et explorons ensemble les meilleures options pour soutenir votre développement.",
    ...
    carrieres: {
      ...
      benefits: {
        ...
        benefit4: "Accès à des outils technologiques uniques"
      },
      opportunities: {
        title1: "Opportunités",
        title2: "actuelles",
        description: "Nous sommes en permanence à la recherche de profils ambitieux, passionnés par l'excellence et l'innovation. Si vous aspirez à avoir un impact réel, à apprendre chaque jour et à progresser dans un environnement bienveillant, parlons-en."
      },
      howToApply: {
        title1: "Comment",
        title2: "postuler",
  ...
  EN: {
    ...
    services: {
      ma: {
        title: "Mergers &",
        titleHighlight: "Acquisitions",
        description: "Our team of experts supports you through all stages of your sale or acquisition project. With a personalized approach and an international network, we maximize the value of your transaction.",
        steps: {
          analysis: {
            title: "Analysis",
            description: "In-depth evaluation of your company"
          },
          valuation: {
            title: "Valuation",
            description: "Determining the fair value"
          },
          targeting: {
            title: "Targeting",
            description: "Identifying potential buyers"
          },
          negotiation: {
            title: "Negotiation",
            description: "Support until signing"
          }
        },
        tagline: "Excellence • Innovation • Results"
      },
      fundraising: {
        title: "Fund",
        titleHighlight: "raising",
        description: "Accelerate your growth with our fundraising expertise. We connect you with the most relevant investors and support you in structuring and negotiating your financing.",
        steps: {
          businessPlan: {
            title: "Business Plan",
            description: "Structuring your project"
          },
          network: {
            title: "Network",
            description: "Access to our investor network"
          },
          presentation: {
            title: "Presentation",
          ...
          closing: {
            title: "Closing",
            description: "Finalizing the financing"
          }
        },
        tagline: "Growth • Financing • Success"
      }
    },
    expertise: {
      title: "Our sector",
      ...
      sectors: {
        ...
        services: {
          ...
          description: "Expertise in optimizing and valuing B2B services"
        },
        energy: {
          title: "Energy & Environment",
          description: "Support for energy transition and sustainable projects"
        }
      }
    },
    aiSection: {
    ...
    process: {
      title: "Our process in",
      titleHighlight: "4 steps",
      subtitle: "Structured and transparent support to maximize your chances of success",
      steps: {
        discovery: {
          number: "01",
          title: "Discovery",
          description: "In-depth analysis of your company, your objectives and your market to define the optimal strategy."
        },
        preparation: {
          number: "02",
          title: "Preparation",
          description: "Creation of the presentation file, valuation and identification of potential counterparties."
        },
        negotiation: {
          number: "03",
          title: "Negotiation",
          description: "Management of exchanges, negotiation of terms and support until the letter of intent is signed."
        },
        closing: {
          number: "04",
          title: "Closing",
          description: "Finalization of legal documentation, coordination of due diligence and support until closing."
        }
      }
    },
    europePresence: {
      ...
      stats: {
        ...
        network: {
          value: "5000+",
          label: "investors in our network"
        }
      }
    },
    contact: {
      modalTitle: "Contact ",
      modalTitleHighlight: "us",
      modalSubtitle: "We are here to discuss your project",
      title: "Let's schedule a call",
      subtitle: "Our team is at your disposal to discuss your project",
      form: {
        fullName: "Full name",
        ...
        submit: "Send message",
        sending: "Sending...",
        successMessage: "Thank you for your message. Our team will contact you as soon as possible.",
    ...
    expertisePages: {
      cession: {
        ...
        stats: {
          ...
          duration: {
            value: "6-9",
            label: "Months on average per sale"
          },
          valuation: {
            value: "+25%",
            label: "Average valuation achieved"
          },
          confidentiality: {
            value: "100%",
    ...
    carrieres: {
      ...
      benefits: {
        ...
        benefit4: "Access to unique technological tools"
      },
      opportunities: {
        title1: "Current",
  ...
  IT: {
    ...
    about: {
      ...
      content: {
        point1: {
          title: "Milaris Partners, società parigina fondata da professionisti italiani e francesi, accompagna micro, piccole e medie imprese nei loro percorsi di",
        ...
        point3: {
          ...
          text2: "nelle operazioni di M&A, utilizziamo una tecnologia proprietaria che rende più efficiente ogni fase della transazione, aprendo nuove possibilità e aumentando le chance di successo."
        }
      }
    },
    services: {
      ma: {
        title: "Fusioni e",
        titleHighlight: "Acquisizioni",
        description: "Il nostro team di esperti vi accompagna in tutte le fasi del vostro progetto di cessione o acquisizione. Con un approccio personalizzato e una rete internazionale, massimizziamo il valore della vostra transazione.",
        steps: {
          analysis: {
            title: "Analisi",
            description: "Valutazione approfondita della vostra azienda"
          },
          valuation: {
            title: "Valutazione",
            description: "Determinazione del giusto valore"
          },
          targeting: {
            title: "Targeting",
            description: "Identificazione dei potenziali acquirenti"
          },
          negotiation: {
            title: "Negoziazione",
            description: "Supporto fino alla firma"
          }
        },
        tagline: "Eccellenza • Innovazione • Risultati"
      },
      fundraising: {
        title: "Raccolta",
        titleHighlight: "fondi",
        description: "Accelerate la vostra crescita con la nostra esperienza nella raccolta fondi. Vi mettiamo in contatto con gli investitori più rilevanti e vi accompagniamo nella strutturazione e negoziazione del vostro finanziamento.",
        steps: {
          businessPlan: {
            title: "Business Plan",
            description: "Strutturazione del vostro progetto"
          },
          network: {
            title: "Network",
            description: "Accesso alla nostra rete di investitori"
          },
          presentation: {
            title: "Presentazione",
            description: "Preparazione dei pitch"
          },
          closing: {
            title: "Closing",
            description: "Finalizzazione del finanziamento"
          }
        },
        tagline: "Crescita • Finanziamento • Successo"
      }
    },
    expertise: {
      ...
      sectors: {
        ...
        industry: {
          title: "Industria",
          description: "Supporto strategico per le aziende industriali e manifatturiere"
        },
        services: {
    ...
    process: {
      title: "Il nostro processo in",
      titleHighlight: "4 fasi",
      subtitle: "Un supporto strutturato e trasparente per massimizzare le vostre possibilità di successo",
      steps: {
        discovery: {
          number: "01",
          title: "Scoperta",
          description: "Analisi approfondita della vostra azienda, dei vostri obiettivi e del vostro mercato per definire la strategia ottimale."
        },
        preparation: {
          number: "02",
          title: "Preparazione",
          description: "Costituzione del dossier di presentazione, valutazione e identificazione delle controparti potenziali."
        },
        negotiation: {
          number: "03",
          title: "Negoziazione",
          description: "Gestione degli scambi, negoziazione dei termini e supporto fino alla firma della lettera d'intenti."
        },
        closing: {
          number: "04",
          title: "Closing",
          description: "Finalizzazione della documentazione legale, coordinamento delle due diligence e supporto fino al closing."
        }
      }
    },
    europePresence: {
      ...
      stats: {
        transactions: {
          value: "+150",
          label: "transazioni completate"
        },
        volume: {
          value: "€2Mld+",
          label: "volume di transazioni"
        },
        network: {
          value: "5000+",
          label: "investitori nella nostra rete"
        }
      }
    },
    contact: {
      modalTitle: "Contattateci",
      modalTitleHighlight: "",
      modalSubtitle: "Siamo a vostra disposizione per discutere del vostro progetto",
      title: "Pianifichiamo una chiamata",
      subtitle: "Il nostro team è a vostra disposizione per discutere del vostro progetto",
      form: {
        ...
        emailProfessional: "Email professionale",
        phone: "Telefono (opzionale)",
        phonePlaceholder: "+39 333 123 4567",
        company: "Azienda",
        project: "Il vostro progetto",
        projectTypes: {
          sale: "Cessione d'azienda",
          acquisition: "Acquisizione",
          fundraising: "Raccolta fondi",
          other: "Altro"
        },
        message: "Il vostro messaggio",
        messagePlaceholder: "Descrivete il vostro progetto o la vostra richiesta...",
        submit: "Invia messaggio",
        sending: "Invio in corso...",
        successMessage: "Grazie per il vostro messaggio. Il nostro team vi contatterà il prima possibile.",
        errorMessage: "Si è verificato un errore. Si prega di riprovare."
      },
      directContact: "O contattateci direttamente:",
      emailAddress: "contact@milaris.partners"
    },
    footer: {
    ...
    expertisePages: {
      ...
      acquisition: {
        hero: {
          ...
          description: "Milaris Partners affianca dirigenti, gruppi industriali e investitori in ogni fase di operazioni di crescita esterna — dall'acquisizione di concorrenti o fornitori a quella di realtà complementari o di diversificazione — con un metodo strategico e mirato, pensato per garantire risultati concreti e duraturi.",
    ...
    carrieres: {
      ...
      values: {
        value1: {
          title: "Esposizione internazionale",
        ...
        value3: {
          ...
          description: "Cresci in un ambiente stimolante, aperto a nuove idee e iniziative. Valorizziamo la curiosità, l'apprendimento continuo e lo spirito di squadra."
        }
      },
      benefits: {
